...
::::: columns
::: {.column width="50%"}
![Andrey Markov](images/Andrei_Markov.jpg){width="150"}
:::

::: {.column width="50%"}
![Carl Gauss](images/330px-Carl_Friedrich_Gauss_1840_by_Jensen.jpg){width="150"}
:::
:::::
...
- (imperfect) Multicollinearity, on its own, is never a reason to drop a variable

- Multicollinearity usually doesn't matter that much. But in severe cases, you might try:
  - Combining correlated variables to make an index
  - Using a penalized regression (ridge or lasso)
