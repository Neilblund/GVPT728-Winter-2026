...
[![McEwan, P. J., & Shapiro, J. S. (2008). The benefits of delayed primary school enrollment: Discontinuity estimates using exact birth dates. Journal of human Resources, 43(1), 1-29.](images/Day-of-Birth-First-grade-Enrollment-Age-and-First-grade-Retention.png){fig-align="center" width="60%"}](https://jhr-uwpress-org.proxy-um.researchport.umd.edu/content/43/1/1.short)
...
![](https://dbknews.s3.amazonaws.com/uploads/2019/05/2014-06-1fc6fc8c258e1d8c1097fa2af21d85f2-2.jpg){fig-align="center" width="80%"}
...
However, the dis-aggregated results suggest that this isn't the case: it's more likely there are two separate trends.
...
Assuming a linear effect when the effect is cubic will produce a spurious result.
...
Looking at the overall scatter plot, there's definitely a positive correlation between winning a seat at time 1 vs. time 2, but that's not especially surprising: popular candidates remain popular.
...
If the incumbency effect is real, we would expect to see a sharp change near the cutoff for winning a seat.
...
A simple test for the assumptions for RDD is to set a different cutoff and see if the results are still significant. If we're finding an effect at winning 49%, that suggests we aren't really seeing an incumbency effect:
