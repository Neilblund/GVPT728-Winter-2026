...
The `get_draws` function will get simulated draws from the posterior distribution. We can use these to get plots showing the average marginal effects for both covariates in the model, along with some additional annotations:
